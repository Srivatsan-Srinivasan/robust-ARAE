...
def train_DCGAN(expt_name = 'DCGAN1'):
    ...
    for epoch in range(train_epoch):
        ...
        p = 'MNIST_DCGAN_results/Random_results/MNIST_DCGAN_' + expt_name + '_'+ str(epoch + 1) + '.png'
        fixed_p = 'MNIST_DCGAN_results/Fixed_results/MNIST_DCGAN_' + expt_name + '_'+ str(epoch + 1) + '.png'
    ...
    interpolated_p = 'MNIST_DCGAN_results/Interpolated_results/MNIST_GAN_' + expt_name + '_' + str(epoch + 1) + '.png'
