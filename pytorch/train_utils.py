...
def load_oracle(args):
    ...
    oracle = NNLM(params)
    oracle.load_state_dict(t.load(args.data_path+'/nnlm.pt', map_location={'cuda:0': 'cuda:'+str(args.gpu_id), 'cuda:1' : 'cuda:'+str(args.gpu_id), 'cuda:2' : 'cuda:'+str(args.gpu_id), 'cuda:3': 'cuda:'+str(args.gpu_id)}))
...
def train_ae(autoencoder, criterion_ce, optimizer_ae, train_data, batch, total_loss_ae, start_time, i, ntokens, epoch, args, writer, n_iter):
    ...
    output = autoencoder.forward(source,
