...
parser.add_argument('--cuda', default=True, type=ast.literal_eval)
...
# Train Model
trained_model = train(train_iter, val_iter=test_iter, early_stopping=args.early_stopping, save=args.save, save_path=args.output_filename,
                      model_params=model_params, opt_params=opt_params, train_params=train_params, cuda=args.cuda, reshuffle_train=True)
